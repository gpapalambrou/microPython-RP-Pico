...
Η γλώσσα MicroPython είναι βασισμένη στην γλώσσα Python και δεν απαιτείται καμμία προηγούμενη γνώση τους - όλα θα γίνουν στο πλαίσιο του μαθήματος! Για βασικές έννοιες της Python δείτε τον [σύνδεσμο](python_intro.md) και την [Βιβλιογραφία](https://github.com/gpapalambrou/Python_intro/blob/main/Bibliography.md) στην Εισαγωγή στην Python.
...
- Κατανοώντας τις ψηφιακές συνδέσεις 
- Έλεγχος ροής και λειτουργιών
- Σύνταξη κώδικα που ανταποκρίνεται στην είσοδο  και ελέγχει τις εξόδους υλικού
...
- Πλακέτες: MPU6050-Accelerometer, SS49-Magnetic sensor, INA219-Current sensor, K-thermocouple & MAX31856, DHT22-Humidity/Temperature sensor
