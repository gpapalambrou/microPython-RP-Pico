...
Η πλατφόρμα Raspberry Pico 2040/2350 είναι μια προσιτή λύση στον χώρο των μικροελεγκτών, ακολουθώντας την προσέγγιση open source στην σχεδίαση της πλακέτας. To Pico συνδέεται με τον ΗΥ μέσω καλωδίου USB, από όπου λαμβάνει τροφοδοσία, μεταφέρει τα δεδομένα και προγραμματίζεται. Ένα Pico προγραμαματίζεται σε MicroPython ή C/C++.
