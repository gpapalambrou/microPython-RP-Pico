...
Το κάθε μάθημα διαθέτει το ένα ή περισσότερα αρχεία Jupyter, πχ `picoL1.ipynb`. Θα κατεβάσετε τα αρχεία αυτά απο το GitHub και θα τα τρέξετε τοπικά από τον ΗΥ σας μέσω ένος browser, αφού πρώτα ανοίξετε ένα τερματικό PowerShell και κατόπιν δώσετε εκεί την εντολή jupyter notebook.  
